...
function startConversation() {
    fetch('https://chatbot-for-little-oak-preschool-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-little-oak-preschool-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbwLBiwmVGjbXVU6SJRQYHMsvkBIEZ7Qn21bfLzdlLkWXK1ZzJmAQToFjxBR3-oS9bMqhQ/exec';
